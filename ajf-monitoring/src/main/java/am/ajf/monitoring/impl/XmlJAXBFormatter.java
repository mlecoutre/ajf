...
public class XmlJAXBFormatter implements EventFormatter {
	 ...
	 * 
	 */
	public XmlJAXBFormatter(Class<?>... eventClasses)
			throws JAXBException {
	...
	@Override
	public String format(AbstractEvent eventSource)
			throws EventFormatterException {
		...
		try {
			...
			throw new EventFormatterException("Unable to format event '"
					+ eventSource.getClass().getName() + "'.", e);
		}
