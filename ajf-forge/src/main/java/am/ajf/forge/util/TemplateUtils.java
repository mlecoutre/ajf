...
public class TemplateUtils {
	...
	//
	// /**
	// * Default constructor (uses the Default template directory in the
	// resource
	...
	//
	// /**
	// * Locate the DEFAULT_TEMPLATES_DIRECTORY directory in the Resources of
	// the
	// * class Loader
	// *
	...
	// */
	// private File locateTemplateDirectory() throws Exception,
	// URISyntaxException {
	//
	...
	// *
	// * @param templateName
	// * @return Template object corresponding to the FreeMarker template file
	// set
	// * as input
	// * @throws Exception
	// */
	...
	// * application name. The aim of this data model is to be use for the
	// Header
	// * template
	// *
