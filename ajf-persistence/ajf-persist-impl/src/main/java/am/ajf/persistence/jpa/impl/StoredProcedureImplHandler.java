...
public class StoredProcedureImplHandler extends AbstractPersistenceImplHandler 
	...
	public StringBuffer generateBodyFor(Method method) throws ClassNotFoundException, NotFoundException, CannotCompileException {
	...
	private Class<?> generateHibernateWorkerForMethod(Method method, boolean isResList, StoredProcedure storedProcedure, int nbArgs) throws NotFoundException, CannotCompileException {
		ClassPool pool = ClassPool.getDefault();
