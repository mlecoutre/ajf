...
public class SchemaGenerator {
	...
	/**
	 * @param args [1] packageNams
	 */
	public static void main(String[] args) throws Exception {
		SchemaGenerator gen = new SchemaGenerator(args[1]); //package name
	...
	private static enum Dialect {
		ORACLE("org.hibernate.dialect.Oracle10gDialect"), MYSQL(
				...
				"org.hibernate.dialect.HSQLDialect"), DERBY(
				"org.hibernate.dialect.DerbyDialect"), DB2(
